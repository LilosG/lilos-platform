...
PERMISSION_CATALOG: dict[str, tuple[str, str, str, str]] = {
    ...
    "seo.read": ("Read SEO", "Read scoped SEO evidence and outcomes.", "seo", "read"),
    "seo.manage": ("Manage SEO", "Manage confirmed SEO collection scope.", "seo", "manage"),
    "seo.recommend": (
        "Recommend SEO",
        "Create evidence-backed SEO recommendations.",
        "seo",
        "recommend",
    ),
    ...
    "seo.execute": (
        "Execute SEO",
        "Create governed SEO implementation requests.",
        "seo",
        "execute",
    ),
    ...
    "insights.manage": (
        "Manage insights",
        "Manage scoped goals and reports.",
        "insights",
        "manage",
    ),
    "insights.publish": (
        "Publish reports",
        "Approve and deliver immutable reports.",
        "insights",
        "publish",
    ),
    "content.rollback": (
