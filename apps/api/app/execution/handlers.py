    ...
    *,
    ...
    if initial_dispatch:
        ...
        try:
            ...
            # Only park this for human reconciliation when the write may actually
            # have landed. A rejected or undelivered request created nothing.
...
async def _handle_gbp_publish_post(
    ...
    *,
    ...
    """Execute the canonical governed GBP Local Post publisher."""
    from apps.api.app.products.gbp.post_publish_handler import handle_gbp_publish_post

    return await handle_gbp_publish_post(
        session,
