"""Isolated PostgreSQL fixture for authorization evaluation tests."""
...
def preserve_application_logger_state() -> Iterator[None]:
    """Keep Alembic fileConfig from disabling application security loggers."""
...
def authorization_session_factory(
    ...
    command.upgrade(config, "head")
    logging.getLogger("lilos.security.authorization").disabled = False
