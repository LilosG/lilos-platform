"""PostgreSQL fixture for GBP-domain tests."""
...
def gbp_session_factory(
    ...
    command.upgrade(config, "head")
    # TestClient and the surrounding helpers use separate event loops. Avoid
    # returning an asyncpg connection created on one loop from a shared pool
    # to another loop during the same integration scenario.
